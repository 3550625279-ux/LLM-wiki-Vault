...
| `wiki/concepts/_index.md` | MoC 索引 | 建议添加: type:meta |
| `wiki/entities/_index.md` | MoC 索引 | 建议添加: type:meta |
| `wiki/insights/_index.md` | MoC 索引 | 建议添加: type:meta |
| `wiki/operations/_index.md` | MoC 索引 | 建议添加: type:meta |
...
| `wiki/domains/_index.md` | `created` |
...
| `wiki/concepts/_index.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
| `wiki/entities/_index.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
| `wiki/insights/_index.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
| `wiki/operations/_index.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
...
**说明**: `_index.md` 页面作为 Dataview MoC 自动生成入口，不强制要求被引用。其余 5 个页面建议从 overview.md 或 getting-started.md 建立入口链接。

---

## Empty Content Stubs — 🟢 LOW (4 pages)

以下 `_index.md` 页面仅含格式模板，无实际内容:

| 页面 | 说明 |
|------|------|
| `wiki/concepts/_index.md` | 空壳——等待 ingest 填充 |
| `wiki/entities/_index.md` | 空壳——等待 ingest 填充 |
| `wiki/insights/_index.md` | 空壳——等待 ingest 填充 |
| `wiki/operations/_index.md` | 空壳——等待 ingest 填充 |
...
2. **补全 getting-started.md 和 domains/_index.md 的 `created` 字段**（2 分钟）

### 🟡 P1 — 本周完成
3. **为 8 个无 frontmatter 的非系统页面添加 frontmatter**（overview + 4 个 _index + 3 个 meta）
