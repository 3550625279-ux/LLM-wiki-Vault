...
| `wiki/concepts/idx.md` | MoC 索引 | 建议添加: type:meta |
| `wiki/entities/idx.md` | MoC 索引 | 建议添加: type:meta |
| `wiki/insights/idx.md` | MoC 索引 | 建议添加: type:meta |
| `wiki/operations/idx.md` | MoC 索引 | 建议添加: type:meta |
...
| `wiki/concepts/idx.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
| `wiki/entities/idx.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
| `wiki/insights/idx.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
| `wiki/operations/idx.md` | MoC 索引 | 正常——MoC 由 Dataview 自动聚合 |
...
| 页面 | 说明 |
|------|------|
| `wiki/concepts/idx.md` | 空壳——等待 ingest 填充 |
| `wiki/entities/idx.md` | 空壳——等待 ingest 填充 |
| `wiki/insights/idx.md` | 空壳——等待 ingest 填充 |
| `wiki/operations/idx.md` | 空壳——等待 ingest 填充 |
...
2. **补全 getting-started.md 和 domains/idx.md 的 `created` 字段**（2 分钟）
