...
3. Add entry to `wiki/overview.md` under a "## Canvases" subsection (append after the Current State section). Do not modify `wiki/concepts-idx.md`. It uses a fixed section schema (Domains, Entities, Concepts, Sources, Questions, Comparisons).
...
4. Update `wiki/concepts-idx.md` when creating new canvases.
